    ...
    <main className="pt-24">
      <section className="section-shell py-16">
        <header className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-bold uppercase tracking-[0.24em] text-clay">Đặt chuyến đi</p>
          <h1 className="mt-3 text-4xl font-extrabold tracking-tight text-ink md:text-6xl">Bạn muốn đi theo cách nào?</h1>
        ...
        <section className="mt-12 grid gap-8 lg:grid-cols-2">
          <article className="group overflow-hidden rounded-3xl bg-white shadow-card transition hover:-translate-y-1">
            <figure className="relative min-h-80">
              <Image src={imageFor("photo-1529156069898-49953e39b3ac")} alt="Đoàn khách du lịch trọn gói có hướng dẫn viên" fill className="object-cover transition duration-700 group-hover:scale-105" />
              <figcaption className="absolute inset-0 bg-gradient-to-t from-forest/85 via-forest/20 to-transparent" />
            </figure>
            <section className="p-8">
              <p className="flex size-12 items-center justify-center rounded-full bg-forest text-white"><Route className="size-6" aria-hidden="true" /></p>
              ...
              <Button asChild size="lg" className="mt-7">
                <Link href="/book-tour/package">Khám phá tour<ArrowRight className="size-5" /></Link>
              </Button>
            </section>
          </article>
          ...
          <article className="group overflow-hidden rounded-3xl bg-white shadow-card transition hover:-translate-y-1">
            <figure className="relative min-h-80">
              <Image src={imageFor("photo-1501785888041-af3ef285b470")} alt="Du khách tự túc khám phá homestay và núi rừng A Lưới" fill className="object-cover transition duration-700 group-hover:scale-105" />
              <figcaption className="absolute inset-0 bg-gradient-to-t from-brown/85 via-brown/20 to-transparent" />
            </figure>
            <section className="p-8">
              <p className="flex size-12 items-center justify-center rounded-full bg-clay text-white"><TentTree className="size-6" aria-hidden="true" /></p>
              ...
              <Button asChild size="lg" className="mt-7 bg-clay hover:bg-brown">
                <Link href="/book-tour/self-guided">Bắt đầu lên kế hoạch<Compass className="size-5" /></Link>
              </Button>
            </section>
          </article>
        </section>
